...
function startConversation() {
    fetch('https://chatbot-for-kids-humpty-dumpty-academy-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-kids-humpty-dumpty-academy-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbzJj56Mln7BI7fW3JuckKDtvnWc7NavJ7vQnRKAaUjl_6MqcIRSecXCirRO5MF80EpzdA/exec';
